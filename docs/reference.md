...
Decoded objects own their state. See [canonical binary encoding](encoding.md)
...
See [profile and ownership semantics](architecture.md),
[compatibility boundaries](compatibility.md),
[specification decisions](specification-decisions.md),
[canonical binary encoding](encoding.md),
[adoption and migration](adoption.md),
[errors and recovery](errors-and-recovery.md),
[structure selection](structures.md), and
